...
..\bin\wget -N --no-check-certificate %proxy% http://live.sysinternals.com/disk2vhd.exe
..\bin\wget -N --no-check-certificate %proxy% http://live.sysinternals.com/disk2vhd.chm
